# Business Model: Manufacture of basic precious and other non-ferrous metals
...
## Classification
- Repository: `cloud-itonami-isic-2420` ([github.com/cloud-itonami/cloud-itonami-isic-2420](https://github.com/cloud-itonami/cloud-itonami-isic-2420))
- ISIC Rev.5: `2420` — Manufacture of basic precious and other non-ferrous metals
- Domain: `:precious-nonferrous-metal-smelting-refining/manufacturing`
- Social impact: :worker-safety :materials-safety :environmental-health :resource-efficiency
- Actor: `:precious-nonferrous-smelting-refining-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :precious-nonferrous-metal-smelting-refining/manufacturing — who wants
...
One managed tenant (:precious-nonferrous-metal-smelting-refining/manufacturing):
...
- Do not bypass the `:precious-nonferrous-smelting-refining-plant-operations-governor` for production decisions.
