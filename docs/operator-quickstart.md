# Operator Quickstart — Manufacture of basic precious and other non-ferrous metals

Shortest path from clone to a verified local dry-run for **ISIC 2420** (`cloud-itonami-isic-2420`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2420.git
cd cloud-itonami-isic-2420
```
...
- Blueprint governor key: `precious-nonferrous-smelting-refining-plant-operations-governor`
- Likely source path: `smeltrefine.governor.cljc`
